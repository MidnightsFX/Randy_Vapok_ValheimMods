...
namespace EpicLoot.MagicItemEffects.Shards
{
    ...
    // weapon's damage at a fully-committed heavy loadout, proportionally less below. Applied per-weapon so an
    // off-hand shard does not leak onto the main hand. Shard values are authored as whole-number percents,
    // hence the 0.01f.
